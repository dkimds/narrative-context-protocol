...
- [~] 4. 3단계: Free_Episodes 에피소드 작성 섹션 업데이트
  - [~] 4.1 진행 상황 한 줄 표시 형식 추가
    - `[진행] [N]회 / 총 [total]회 | 현재 구간: [무료/유료/최종결말] | 아이데이션: [N차] 완료` 형식 명시
    - 매 회차 A단계(회차 내용 제안) 시작 전 표시 규칙 작성
    - _요구사항: 6.4_
  - [~] 4.2 에피소드 JSON에 story.ideation 필드 추가
...
- [~] 13. 예시 파일 작성 — ideation-phase3.json
  - [~] 13.1 `examples/ideation-phase3.json` 작성
    ...
    - _요구사항: 4.2, 4.3, 4.4_
  - [ ] 13.2 ideation-phase3.json 스키마 검증
    - `npm run validate:file -- ./examples/ideation-phase3.json` 실행하여 PASS 확인
    - _요구사항: 4.2 (Property 2, Property 3, Property 4)_

- [ ] 14. 구조 검증 스크립트 작성 — tests/validate-skill-structure.js
  - [ ] 14.1 SKILL.md 구조 검증 스크립트 작성
