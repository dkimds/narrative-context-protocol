...
**저장 안내:**
```
위 JSON을 examples/ideation-phase1.json 으로 저장하세요.
저장 후 검증: npm run validate:file -- ./examples/ideation-phase1.json
```
...
```
위 JSON을 examples/ideation-phase2.json 으로 저장하세요.
저장 후 검증: npm run validate:file -- ./examples/ideation-phase2.json
```
...
```
위 JSON을 examples/ideation-phase3.json 으로 저장하세요.
저장 후 검증: npm run validate:file -- ./examples/ideation-phase3.json
```
